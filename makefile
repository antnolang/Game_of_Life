...
main_debug: main.o world.o world_toroidal.o world_limited.o config.o
	gcc $(CFLAGS) -g main.o world.o world_toroidal.o world_limited.o config.o -o main_debug

main: main.o world.o world_toroidal.o world_limited.o config.o
	gcc $(CFLAGS) main.o world.o world_toroidal.o world_limited.o config.o -o main
